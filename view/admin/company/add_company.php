...
<div class="container ">
    ...
    <div class="container mt-5">
        <div class="d-flex p-2 bg-secondary-subtle">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                <a href="index.php?action=bus" class="btn bg-orange text-white">Les entreprises</a>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
        ...
        <form class="main-form" action="index.php?action=add_company_action" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <label>Name</label>
                            <input type="text" class="form-control" name="name" required placeholder="Name Of Company">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
