...
<div class="container ">
    ...
    <div class="container mt-5">
        ...
        <form class="main-form" action="index.php?action=update_route_action" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <input type="text" class="form-control" hidden name="old_depart" value="<?= $route->getDepartue_city() ?>">
                            <input type="text" class="form-control" hidden name="old_arrive" value="<?= $route->getDestination_city() ?>">
                            <label>DÉPART</label>
                            <select class="form-control" id="depart" name="depart">

                                <option disabled selected>Ville de départ</option>
                                <?php foreach ($cities as $city) { ?>
                                    <?php if ($city->getName() === $route->getDepartue_city()) { ?>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            ...
                            <select class="form-control" id="arrive" name="arrive">
                                ...
                                <?php foreach ($cities as $city) { ?>
                                    <?php if ($city->getName() === $route->getDestination_city()) { ?>
                                        <option selected><?= $city->getName(); ?></option>
                                    <?php } else { ?>
                                        <option><?= $city->getName(); ?></option>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            ...
                            <input type="number" class="form-control" name="distance" value="<?= $route->getDistance() ?>" required placeholder="Distance">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <label>Durée</label>
                            <input type="text" class="form-control" name="duration" value="<?= $route->getDuration() ?>" id="duration" required placeholder="Entrée un durée sous forme hh:mm:ss">
                        </div>
