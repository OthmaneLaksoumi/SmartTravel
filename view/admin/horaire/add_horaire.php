...
<div class="container ">
    ...
    <div class="container mt-5">
        ...
        <form class="main-form border border-dark-subtle" action="index.php?action=add_horaire_action" method="post">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            ...
                            <input type="number" class="form-control" name="nbr_seats" required>
                        </div>
